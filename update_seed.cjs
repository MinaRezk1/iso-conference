...
const newSchedule = `export const INITIAL_SCHEDULE: EventSchedule[] = [
  ...
  { id: "event1_2", title: "تجمع + تحرك", time: "07:00 AM - 08:00 AM", day: 1, location: "", responsible: "كل الخدام", icon: "Bus", completed: false },
  { id: "event1_3", title: "دراسة الكتاب", time: "11:00 AM - 12:00 PM", day: 1, location: "قاعة + كافيتريا", responsible: "شادي سامح", icon: "BookOpen", completed: false },
  ...
  { id: "event1_5", title: "استلام الغرف", time: "01:00 PM - 02:00 PM", day: 1, location: "", responsible: "يوسف سمير + شادي سامح", icon: "DoorOpen", completed: false },
  { id: "event1_6", title: "Pool + Hand Ball", time: "01:00 PM - 03:00 PM", day: 1, location: "", responsible: "مينا ابو اليمين", icon: "Gamepad2", completed: false },
  ...
  { id: "event1_15", title: "العاب (volley+baseball)", time: "09:30 PM - 11:00 PM", day: 1, location: "الملعب", responsible: "يوسف+كيرلس+مينا+بطرس+جوني+فادى", icon: "Gamepad2", completed: false },
  { id: "event1_16", title: "دورى American", time: "11:00 PM - 12:30 AM", day: 1, location: "الملعب", responsible: "يوسف+كيرلس+مينا+بطرس+جوني+فادى", icon: "Trophy", completed: false },

  // Day 2
  { id: "event2_1", title: "صحيان", time: "08:00 AM - 08:30 AM", day: 2, location: "", responsible: "كيرلس وفيق + جوني اديب", icon: "Sun", completed: false },
  ...
  { id: "event2_6", title: "Pool + Hand Ball", time: "11:30 AM - 01:00 PM", day: 2, location: "", responsible: "مينا ابو اليمين", icon: "Gamepad2", completed: false },
  { id: "event2_7", title: "SHOWER", time: "01:00 PM - 01:30 PM", day: 2, location: "", responsible: "", icon: "Sparkles", completed: false },
  ...
  { id: "event2_14", title: "لعبة الجريمة", time: "08:00 PM - 09:30 PM", day: 2, location: "الملعب", responsible: "حسني+مينا+جوني+يوسف.س", icon: "Gamepad2", completed: false },
  ...
  // Day 3
  { id: "event3_1", title: "صحيان", time: "07:30 AM - 08:00 AM", day: 3, location: "", responsible: "شادي سامح + هاني حربي", icon: "Sun", completed: false },
  ...
  { id: "event3_6", title: "Pool + Hand Ball", time: "11:30 AM - 02:00 PM", day: 3, location: "", responsible: "مينا ابو اليمين", icon: "Gamepad2", completed: false },
  { id: "event3_7", title: "SHOWER", time: "02:00 PM - 02:30 PM", day: 3, location: "", responsible: "", icon: "Sparkles", completed: false },
